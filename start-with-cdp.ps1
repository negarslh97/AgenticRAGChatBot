# 🤖 اسکریپت راه‌اندازی Sally با CDP
# این اسکریپت Chrome را با CDP فعال راه‌اندازی می‌کند
...
if ($chromeProcesses) {
    ...
    Write-Host "   ℹ️ No Chrome processes found" -ForegroundColor Gray
}
...
Write-Host '    "task": "ایجاد ادمین جدید...",' -ForegroundColor Gray
