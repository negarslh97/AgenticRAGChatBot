...
const AdminFileUpload: React.FC<FileUploadProps> = ({
  ...
  const handleFile = async (file: File) => {
    ...
    try {
      ...
      // Upload to backend
      console.log("AdminFileUpload: Sending request to /api/super-admin/kb/articles/upload");
      const response = await api.post("/api/super-admin/kb/articles/upload", formData, {
        headers: {
